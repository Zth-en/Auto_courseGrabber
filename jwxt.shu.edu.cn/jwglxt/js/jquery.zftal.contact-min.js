...
;(function(e) {
    ...
    e.extend({
        bindChangeEvent: function(w, g, n, o, h, p, u, j, m, domain) {
			//domain = {showSearch:true, ctnAll:true, ctnInvert:true} //搜索框 全选 反选
            var k = this;
            var i = {};
            u = e.defined(u) ? u : {};
            ...
            if (e.founded(p) && e(p).defined()) {
                ...
                e(p).unbind("change").change(function() {
            ...
            if (e.founded(w) && e(w).defined()) {
                ...
                e(w).unbind("change").change(function() {
                    if (e.founded(e(this).val())) {
                        i[x] = e(this).val();
                        f(this)
                    } else {
            ...
            if (e.founded(g) && e(g).defined()) {
                ...
                e(g).unbind("change").change(function() {
                    if (e.founded(e(this).val())) {
                        i[x] = e(this).val();
                        f(this)
                    } else {
            ...
            if (e.founded(n) && e(n).defined()) {
                ...
                e(n).unbind("change").change(function() {
                    if (e.founded(e(this).val())) {
                        i[x] = e(this).val();
                        f(this)
                    } else {
