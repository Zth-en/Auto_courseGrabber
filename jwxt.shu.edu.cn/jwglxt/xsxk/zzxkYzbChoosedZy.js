		...
		if(data!=null && data.length>0){
			...
			for(var i=0; i<data.length; i++){
				...
				if(rightKchId!=modelA.t_kch_id){
					...
					s_html.push(modelA.kcmc+" - "+modelA.xf+" "+$.i18n.get("msg_xf"));
...
function openDjxbWin(trObj,kch_id,jxb_id,do_jxb_id,jxbzls,syqz){
	$.showDialog(_path +'/xsxk/zzxkyzb_xkZyZzxkYzbZjxb.html?jxb_id='+jxb_id+'&do_jxb_id='+do_jxb_id+'&jxbzls='+jxbzls+'&rlkz='+$("#rlkz").val()+'&fxbj='+$("#fxbj_"+kch_id).val()+'&cxbj='+$("#cxbj_"+kch_id).val()+'&rlzlkz='+$("#rlzlkz").val()+'&cdrlkz='+$("#cdrlkz").val()+'&rwlx='+$("#rwlx").val()+'&syqz='+syqz,$.i18n.get("msg_xzkc"),{
		width:"850px",
		modalName:"addModal",
		buttons:{
			success : {
...
function saveDjxbCourseBc(trObj,kch_id,jxb_id,do_jxb_id,jxbzls,jxb_arr,jcxx_arr){
	...
	$.post(_path+"/xsxk/zzxkyzbjk_xkBcZyZzxkYzb.html",{
		...
		rlkz:rlkz,cdrlkz:cdrlkz,rlzlkz:rlzlkz,sxbj:sxbj,xxkbj:xxkbj,cxbj:$("#cxbj_"+kch_id).val(),kklxdm:$("#kklxdm").val(),
		xkkz_id:$("#xkkz_id").val(),"njdm_id_xs":$("#njdm_id_xs").val(),"zyh_id_xs":$("#zyh_id_xs").val(),	
...
function refreshDataDelZzxk(trObj,jxb_id,do_jxb_id,kch_id,jxbzls,wz){
	...
	var jxbxf = $("#right_"+jxb_id).find("input[name='right_jxbxf']").val();
